...
const selectCls =
  ...
  "text-zinc-900 outline-none transition focus:border-emerald-600 focus:ring-2 " +
  "focus:ring-emerald-600/20 disabled:cursor-not-allowed disabled:bg-zinc-50 disabled:text-zinc-400";
...
export default function HeroQuoteForm() {
  ...
  return (
    <div className="rounded-2xl border border-zinc-200 bg-white p-5 shadow-[0_20px_60px_-15px_rgba(16,24,28,.25)] sm:p-6">
